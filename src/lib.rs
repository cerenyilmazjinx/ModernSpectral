// src/lib.rs
/*
 * Core library for ModernSpectral
 */
...
#[derive(Debug)]
pub struct ModernSpectralProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ModernSpectralProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ModernSpectral processing");
    
    let mut processor = ModernSpectralProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ModernSpectralProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ModernSpectralProcessor::new(false);
